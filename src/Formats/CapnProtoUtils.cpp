...
#pragma GCC diagnostic pop
    ...
    catch (const kj::Exception & e)
    {
        ...
        throw Exception(ErrorCodes::CANNOT_PARSE_CAPN_PROTO_SCHEMA, "Cannot parse CapnProto schema, file: {}:{}, error: {}", String(e.getFile()), e.getLine(), String(e.getDescription().cStr()));
    }
