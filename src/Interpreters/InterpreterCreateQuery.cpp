...
InterpreterCreateQuery::TableProperties InterpreterCreateQuery::getTablePropertiesAndNormalizeCreateQuery(ASTCreateQuery & create) const
{
    ...
    else if (create.as_table_function)
    {
        ...
        /// Some table functions may not have table structure, because it will be determined in Storage constructor.
        /// In such cases we can leave columns list empty.
        if (table_function->hasStaticStructure())
        {
                                           ...
                                           const InterpreterCreateQuery::TableProperties & properties)
{
    ...
    if (create.as_table_function)
    {
        ...
        res = table_func->execute(create.as_table_function, getContext(), create.table, properties.columns, /*use_global_context=*/true);
