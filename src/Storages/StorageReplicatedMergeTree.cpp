...
StorageReplicatedMergeTree::StorageReplicatedMergeTree(
    ...
    , zookeeper_path(zkutil::extractZooKeeperPath(zookeeper_path_))
    ...
    ContextPtr query_context)
{
    ...
    String from = zkutil::extractZooKeeperPath(expand_from);
    if (from.empty())
    ...
    const ASTPtr & partition, bool move_part, const String & to, ContextPtr /*query_context*/)
{
    ...
    if (zkutil::normalizeZooKeeperPath(zookeeper_path) == zkutil::normalizeZooKeeperPath(to))
