    ...
    if (columns_.empty())
    {
        auto read_buffer_creator = [this, context_]()
        {
            ...
            return wrapReadBufferWithCompressionMethod(
                std::make_unique<ReadBufferFromS3>(client_auth.client, client_auth.uri.bucket, current_key, max_single_read_retries, context_->getReadSettings(), DBMS_DEFAULT_BUFFER_SIZE),
