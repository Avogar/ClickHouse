...
class JSONCompactEachRowRowNamesAndTypesReader : public INamesAndTypesReader
{
public:
    explicit JSONCompactEachRowRowNamesAndTypesReader(ReadBuffer & in_);

    friend JSONCompactEachRowRowInputFormat;
